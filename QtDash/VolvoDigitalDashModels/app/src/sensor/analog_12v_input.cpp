...
Analog12VInput::Analog12VInput(const Analog12VInput::Analog12VInputConfig& conf) : mConfig(conf) {
...
qreal Analog12VInput::getVoltage(qreal volts) const {
    // Equation: Vin = volts * (optoR1 / optoR2) * (1 / optoK3) * ( (inputR2 + inputR1) / inputR2 )
